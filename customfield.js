...
var ganttChart = new ej.gantt.Gantt({
		...
		columns: [
			...
			{ field: 'isParent',  headerText: 'Custom Column',displayAsCheckBox: true,editType: "booleanedit", textAlign: 'Center',width: 100, edit: { params: { checked: true}}}
...
function actionComplete(requestType,data,recordIndex) {
	debugger;
